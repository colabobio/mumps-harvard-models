...
print(sprintf("Maximum number of cumulative cases with intervention: %i", max(sim_data_int$cumulative)))
print(sprintf("Maximum number of cumulative cases w/out intervention: %i", max(sim_data_noint$cumulative)))
