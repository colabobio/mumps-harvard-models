---
title: "Baseline epi model for Harvard outbreak with variable transmission rates"
...
This notebook fits the parameters of a baseline SEIR model with variable transmission rate (representing effect of school breaks) and constant removal rate.
...
print(sprintf("Maximum number of cumulative cases: %i", max(sim_data_int$cumulative)))
